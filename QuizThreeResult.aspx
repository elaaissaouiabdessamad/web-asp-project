<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuizThreeResult.aspx.cs" Inherits="FirstWebApplication.QuizThreeForm" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <asp:Panel runat="server" CssClass="main" ID="resultContent">
                ...
                <asp:HyperLink runat="server" ID="lnkDownloadCertificate" CssClass="btn-download" Text="Download Certificate" NavigateUrl="ChapterThreeCertificate.pdf"></asp:HyperLink>
            </asp:Panel>
        </div>
    </form>
</body>
